...
public class ProjectControllerImpl extends CommonController implements ProjectController {
     ...
     */
    @Override
    public final ModelAndView addFilters (@RequestParam(required = false, name = "emailTemplate") final String emailTemplate, @PathVariable final Boolean sendEmail, @ModelAttribute FilterCreationDto form, HttpServletRequest request) {
